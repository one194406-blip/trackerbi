-- Add filename parsing columns to audio_analysis_results table
-- Pattern: 9080093260_English_Nisarga_20251022164012
-- Components: phone_number_language_name_YYYYMMDDHHMMSS

USE trackerbi_audio;

-- Add new columns for parsed filename components
